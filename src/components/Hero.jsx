...
function Hero() {
  ...
  return (
    <section
      id="hero"
      className="relative min-h-screen flex flex-col items-center justify-center px-4 pt-20 md:pt-6"
    >
      ...
      <div className="pt-10 space-y-10 opacity-0 animate-fade-in-delay-4">
      ...
      <div className="absolute md:bottom-8 left-1/2 transform -translate-x-1/2 md:flex md:flex-col md:items-center animate-bounce hidden">
        <a href="#about">
